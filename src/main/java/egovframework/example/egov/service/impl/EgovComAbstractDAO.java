package egovframework.example.egov.service.impl;
 ...
 * </pre>
 */
public class EgovComAbstractDAO extends SqlMapClientDaoSupport {

    /**
     * EgovComAbstractDAO 는 base class 로만 사용되며 해당 인스턴스를 직접
     * 생성할 수 없도록 protected constructor 로 선언하였음.
     */
    protected EgovComAbstractDAO() {
     ...
     *        파라메터 객체(보통 VO 또는 Map)
     * @param resultObject
     *        - 단건 조회기 결과를 얻기 위한 객체(보통 VO 또는 Map)
     * @return 결과 객체 - SQL mapping 파일에서 지정한
     *         resultClass/resultMap 에 의한 단일 결과 객체(보통
     *         VO 또는 Map)
     */
    public Object selectByPk(String queryId, Object parameterObject, Object resultObject) {
